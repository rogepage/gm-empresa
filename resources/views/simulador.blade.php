																				...
																				<div class="card">
																								<div class="card-body">
																												...
																												@if ($parametro->investimento == 1)
																																<div class="mb-3">
																																				...
																																				<select class="form-control" name="dell_investimento" id="combo_dell_investe">
																																								<option value="0"
																																												{{ old('dell_investimento', isset($form['dell_investimento']) ? $form['dell_investimento'] : 0) == '0' ? 'selected' : '' }}>
																																												Não
																																								</option>
																																								<option value="1"
																																												{{ old('dell_investimento', isset($form['dell_investimento']) ? $form['dell_investimento'] : 0) == '1' ? 'selected' : '' }}>
																																												Sim
																																								</option>
																																				</select>
																																</div>
																																...
																																<div class="mb-3" id="dell_investe" style="display: none">
																																				<label for="campo3" class="form-label">Valor a ser investido: R$
																																								{{ $parametro->valor_investimento }}</label>
																																</div>
																												@endif
																												...
																												@if ($simulador)
																																<div class="col-md-4">
																																				<div
																																								class="{{ $simulador->lucro_dell > 0 ? 'bg-success' : 'bg-warning' }} mb-3 p-3 text-white">
																																								Lucro: {{ money($simulador->lucro_dell, 'BRL') }}</div>
																																</div>

																																<div class="col-md-4">
																																				<div class="bg-light text-dark mb-3 p-3">Mercado: {{ $simulador->mercado_dell }}
																																				</div>
																																</div>
																								...
																								<div class="card-body">
																												...
																												<div class="mb-3">
																																...
																																<input type="text" class="form-control" id="hp_valor" name="hp_valor"
																																				...
																																				placeholder="ex: 2.500,00" onkeyup="formatarMoeda(this)">
																												</div>
																												<div class="mb-3">
																												...
																												<div class="mb-3">
																																...
																																<input type="text" class="form-control" id="hp_publicidade"
																																				...
																																				name="hp_publicidade" placeholder="ex: 3" onkeyup="formatarMoeda(this)">
																												</div>
																												@if ($parametro->investimento == 1)
																																<div class="mb-3">
																																				<label for="campo3" class="form-label">Investir em linha de produção?</label>
																												...
																												@if ($simulador)
																																<div class="col-md-4">
																																				<div
																																								class="{{ $simulador->lucro_hp > 0 ? 'bg-success' : 'bg-warning' }} mb-3 p-3 text-white">
																																								Lucro: {{ money($simulador->lucro_hp, 'BRL') }}</div>
																																</div>

																																<div class="col-md-4">
																																				<div class="bg-light text-dark mb-3 p-3">Mercado: {{ $simulador->mercado_hp }}
																																				</div>
																																</div>
