...
<body>
  <div class="container">
            ...
            <div class="card-body">
              ...
              {{-- <form> --}}
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="hp_valor" name="hp_valor" placeholder="ex: 2.500,00" onkeyup="formatarMoeda(this)">
                </div>
                <div class="mb-3">
    ...
    <button type="submit" class="btn btn-primary mt-3">Simular 3</button>
